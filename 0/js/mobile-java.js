...
const testResult = document.querySelector(`h2`);

if (isMobileDevice()) {
  testResult.innerText = `This is a mobile device.`;
  loadscript("core.js");
  loadscript("charts.js");
  loadscript("plugins/wordCloud.js");
  loadscript("themes/animated.js");
  loadscript("script.js");
}
else {
  testResult.innerText = `This is not a mobile device.`;
  loadscript("core.js");
  loadscript("charts.js");
  loadscript("plugins/wordCloud.js");
  loadscript("themes/animated.js");
